...
import vsSource from "./shader/filter.vert?raw";
import fsSource from "./shader/filter.frag?raw";
...
const FilterComponent = ({
  ...
  const controlPannel = () => {
    ...
    gui.domElement.style.top = `${top}px`; // 距离左侧 20px
    gui.domElement.style.right = `${right}px`; // 距离左侧 20px
  };
